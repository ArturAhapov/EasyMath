package com.arturagapov.easymath.Util;
...
public class IabHelper {
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                buyIntentBundle = mService.getBuyIntent(3, mContext.getPackageName(), sku, itemType, extraData); //getBuyIntentToReplaceSkus(5, mContext.getPackageName(), oldSkus, sku, itemType, extraData);
            }
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            logDebug("BuyPremium2Activity data: " + purchaseData);
            ...
            try {
                ...
                if (!Security.verifyPurchase(mSignatureBase64, purchaseData, dataSignature)) {
                    logError("BuyPremium2Activity signature verification FAILED for sku " + sku);
                    result = new IabResult(IABHELPER_VERIFICATION_FAILED, "Signature verification failed for sku " + sku);
                    if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, purchase);
                    return true;
                }
                logDebug("BuyPremium2Activity signature successfully verified.");
            }
            ...
            logDebug("BuyPremium2Activity canceled - Response: " + getResponseDesc(responseCode));
            result = new IabResult(IABHELPER_USER_CANCELLED, "User canceled.");
            if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
        }
        else {
            logError("BuyPremium2Activity failed. Result code: " + Integer.toString(resultCode)
    ...
    public static String getResponseDesc(int code) {
        ...
        String[] iabhelper_msgs = ("0:OK/-1001:Remote exception during initialization/" +
                ...
                "-1003:BuyPremium2Activity signature verification failed/" +
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        do {
            ...
            for (int i = 0; i < purchaseDataList.size(); ++i) {
                ...
                if (Security.verifyPurchase(mSignatureBase64, purchaseData, signature)) {//if (Security.verifyPurchase(mSignatureBase64, purchaseData, signature)) {
                    ...
                    logWarn("BuyPremium2Activity signature verification **FAILED**. Not adding item.");
                    logDebug("   BuyPremium2Activity data: " + purchaseData);
