...
public class AfterQuizActivity extends Activity implements com.facebook.ads.AdListener, GoogleApiClient.ConnectionCallbacks,
    ...
    private void setAds() {
        if (!Data.userData.isPremium()) {
            ...
            //NativeAd by Facebook
            nativeAd = new NativeAd(this, "1089755054476898_1090611441057926");
    ...
    public void onAdLoaded(Ad ad) {
        ...
        viewAttributes = new NativeAdViewAttributes()
                ...
                .setButtonColor(getResources().getColor(R.color.colorBlueLight))
        ...
        LinearLayout templateContainer = (LinearLayout) findViewById(R.id.nativeAdByFacebook_after_quiz_activity);
