...
import com.arturagapov.easymath.Util.*;
...
public class BuyPremiumActivity extends Activity implements IabBroadcastReceiver.IabBroadcastListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diffucultyString = intent.getStringExtra("diffucultyString");
        difficultyInt = intent.getIntExtra("difficultyInt", -1);

        //Appodeal

        String appKey = "29acd141ba8e7b81cff296e1c4203f6d743b353a4f6f722e";
        ...
        Appodeal.setRewardedVideoCallbacks(new RewardedVideoCallbacks() {
            ...
            public void onRewardedVideoLoaded() {
                Button buttonTryForRewarded = (Button) findViewById(R.id.button_try_for_rewarded);
                buttonTryForRewarded.setVisibility(View.VISIBLE);
                TextView textTryForRewarded = (TextView) findViewById(R.id.try_for_rewarded);
                textTryForRewarded.setVisibility(View.VISIBLE);
            }
    ...
    private void setIntentToGo() {

        if(diffucultyString==null){
            diffucultyString = "Easy";
        }
        if (level.equals("learn")) {
            ...
            intent.putExtra("Unit", unit);
            intent.putExtra("diffucultyString",diffucultyString);
            startActivity(intent);
    ...
    public void onClickTryForFree(View view) {
